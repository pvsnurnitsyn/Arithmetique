...
\begin{enumerate}[topsep=0pt]
    ...
    \item Пусть $a,b,c$ --- решение диофантова уравнения $a^2+b^2=c^2$, $a,b,c \in \mathbb{Z}$, $(a,b)=(b,c)=(c,a)=1$ и (без ограничения общности) $a\equiv 0\ (2)$. Докажите, что существуют целые числа $u,v$ такие, что $c-b=2u^2$, $c+b=2v^2$, $(u,v)=1$, и, как следствие, $a=2uv$, $b=v^2-u^2$, $c=v^2+u^2$.
...
\noindent\textbf{Темы для самостоятельного изучения (опиционально)}
\begin{itemize}[topsep=0pt]
