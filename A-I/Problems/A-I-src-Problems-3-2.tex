...
\begin{itemize}[topsep=0pt]
    ...
    %\item Докажите, что $\forall$ простого $p$ множество целых $p$-адических чисел $\mathbb{Z}_p$ гомеоморфно множеству $2$-адических чисел $\mathbb{Z}_2$. (Подсказка: можно подсмотреть в [Gouv], но лучше сначала попробовать подумать самостоятельно)
\end{itemize}
