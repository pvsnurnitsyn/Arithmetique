...
\begin{center} \Large \bf Листок 3\\ Тема 3 (1.3). Первообразные корни \end{center}
...
\begin{enumerate}[topsep=0pt]
    ...
    \item Пусть $p>2$ --- простое, $g$ --- первообразный корень $\bmod\ p^n$. Докажите, что тогда $g$ --- первообразный корень $\bmod\ p$. %[IR, p48, Ex3]
    \item Пусть $p$ --- простое, $p \equiv 1\ (4)$. Докажите что $g$ --- первообразный корень $\bmod\ p$ $\Leftrightarrow$ $-g$ --- первообразный корень $\bmod\ p$. %[IR, p48, Ex4]
    \item Пусть p --- простое, $p \equiv 3\ (4)$. Докажите что $g$ --- первообразный корень $\bmod\ p$ $\Leftrightarrow$ $-g$ имеет порядок $(p-1)/2$. %[IR, p48, Ex5]
    \item Пусть $p>2$ --- простое. Докажите, что $g$ --- первообразный корень $\bmod\ p$ $\Leftrightarrow$\\ $g^{(p-1)/q}\not\equiv 1 (p)$ для всех простых делителей $q\ |\ p-1$. %[IR, p48, Ex8]
    \item Пусть $p>2$ --- простое. Докажите, что ${\prod\limits_{g}}'g \equiv (-1)^{\varphi(p-1)}\ (p)$, где $\prod'$ --- произведение по всем $0\leqslant g \leqslant p-1$, $g$ --- первообразный корень $\bmod\ p$. %[IR, p48, Ex9]
    \item Пусть $g$ --- первообразный корень $\bmod\ p$, $d|(p-1)$. Докажите, что $g^{(p-1)/d}$ имеет порядок $d$, а также что $a$ является $d$-ой степенью $\Leftrightarrow$ $a \equiv g^{kd} (p)$ для некоторого $k$. %[IR, p48, Ex21]
...
%     \item Пусть $a$ --- наименьшее положительное число являющееся первообразным корнем $\bmod\ p$. Постройте частотную таблицу для $a$, что можно заметить?
...
\begin{itemize}[topsep=0pt]
    \item Необходимые сведения о конечных группах ([LN, параграф 1.1]).
    \item Структура группы единиц $U(\mathbb{Z}/2^l\mathbb{Z})$ ([IR, глава 4], [Вин, глава 6]).
    \item Критерии разрешимости сравнения $x^n\equiv a\ (n)$ ([IR, глава 4]).
