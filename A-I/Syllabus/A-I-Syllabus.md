...
| *Раздел 2. Конечные поля и тригонометрические суммы* | | | | | |
...
4. Докажите, что если $d|n$ и $\Phi_n$ определен, то $\Phi_n\ |\ \dfrac{x^n-1}{x^d-1}$.
...
9. Докажите, что для функций определенных в лекции выполняется $d(n)=d_1(n)-d_3(n)$. 
